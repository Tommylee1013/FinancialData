...
OUTPUT_PATH = Path(
    "data_warehouse/raw/index/nasdaq_index.parquet"
)
LOGGER = setup_logger(
    name = 'us_nasdaq_index_job',
    log_path = 'logs/jobs/us_nasdaq_index.log'
) # Logger 설정
...
def get_nasdaq_symbol_info() -> pd.DataFrame:
    """
...
def transform_index_data(
    ...
    # 미국 정규장 마감 시각: New York local time 16:00
    ...
    # Historical U.S. DST rules are applied automatically.
    market_close_datetime = (
        market_close_datetime
        .dt.tz_localize(
            "America/New_York",
